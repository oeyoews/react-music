  ...
  return (
    <Drawer.Root shouldScaleBackground>
      ...
      <Drawer.Portal>
        ...
        {/* prose 不会继承 */}
        <Drawer.Content className="backdrop-blur-md bg-white dark:prose-invert flex flex-col rounded-t-[10px] h-[80%] mt-24 fixed bottom-0 inset-x-0 z-[99999] prose max-w-none">
          <div className="p-4 rounded-t-[10px] flex-1 overflow-auto">
            <div className="mx-auto overflow-auto w-12 h-1.5 flex-shrink-0 rounded-full mb-8 cursor-pointer" />
