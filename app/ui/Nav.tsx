...
export default function Nav() {
  ...
  return (
    <div className="sticky flex items-center mx-auto justify-end print:hidden top-0 left-0 right-0 z-[1000] backdrop-blur-sm p-4 bg-white/30 max-w-7xl space-x-4">
      {navItems.map((item) => (
